        ...
        <div class="content">
            ...
            <div class="dashboard-cards">
                ...
                <div class="card" id="courses">
                    ...
                    <a href="/faculty/courses?facultyId=<%=f.getFacultyId() %>" class="btn">My Courses</a>
                </div>
                <!-- Attendance Card -->
                <div class="card" id="attendance">
                    <h2>AttendanceProfile</h2>
                    <p>Post attendance records.</p>
                    <a href="/faculty/attendance?facultyId=<%=f.getFacultyId() %>" class="btn">Post Attendance</a>
                </div>
                <!-- Students Card -->
                <div class="card" id="students">
                    <h2>StudentProfiles</h2>
                    <p>Student Details</p>
                    <a href="/faculty/getstudents" class="btn">Students</a>
                </div>
            </div>
        </div>
    </div>
